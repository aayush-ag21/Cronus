#This carries out face detection on dropbox synced files uploaded by Raspberry Pi
import cv2
import numpy as np
import datetime
import time
...
for n in range (1000):
    try:
        ...
        #out1 = cv2.VideoWriter('VIDEO FEED OUTPUT\Output%3d.avi' % (2*n+1),fourcc,10.0,(640,480))
        #out2 = cv2.VideoWriter('VIDEO FEED OUTPUT\Output%3d.avi' % (2*n+2),fourcc,10.0,(640,480))
